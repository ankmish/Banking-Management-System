...
jf.setSize(970,700);
jf.show();    // for making the component added on the panel to come in front of the frame

label1=new JLabel("Account Opening Form");
...
textfield1.setFont(new Font("Dialog", Font.BOLD, 17));
...
label12=new JLabel("Nationality :");
...
if(count==1) {
        ...
        pst=cn.prepareStatement("insert into customer1 values('"+name+"','"+gender+"','"+password+"','"+dobb+"','"+mobileNumber+"','"+email+"','"+area+"','"+state+"','"+nationality+"',"+index+","+acc+","+bal+")");
        ...
        {
            JOptionPane.showMessageDialog(null,"Error on Registration .....Try Again.!!!!!!");  
